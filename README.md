...
| [폰켓몬](programmers/lv1/폰켓몬) | Lv1 | 69% | ✅ | ✅ | min(), 정수 나눗셈(//) |
| [모의고사](programmers/lv1/모의고사) | Lv1 | 67% | ✅ | ✅ | itertools.cycle, sum() 제네레이터, enumerate(start=1) |
| [소수 찾기](programmers/lv1/소수찾기) | Lv1 | 64% | ✅ | ✅ | 에라토스테네스의 체, sum() |
| [실패율](programmers/lv1/실패율) | Lv1 | 63% | ✅ | ✅ | Counter, 누적합 |
| [로또의 최고 순위와 최저 순위](programmers/lv1/로또의최고순위와최저순위) | Lv1 | 61% | ✅ | ✅ | list.count(), min()/max()로 상한·하한 정하기 |
| [[1차] 다트 게임](programmers/lv1/[1차]다트게임) | Lv1 | 61% | ✅ | ✅ | if-elif 사슬 → 딕셔너리 매핑 |
| [완주하지 못한 선수](programmers/lv1/완주하지못한선수) | Lv1 | 60% | ✅ | ✅ | Counter 뺄셈으로 차집합, next(iter()) |
| [체육복](programmers/lv1/체육복) | Lv1 | 60% | ✅ | ✅ | 컴프리헨션, set/discard |
| [크레인 인형뽑기 게임](programmers/lv1/크레인인형뽑기게임) | Lv1 | 55% | ✅ | ✅ | next(), enumerate로 첫 원소 찾기 |
| [키패드 누르기](programmers/lv1/키패드누르기) | Lv1 | 54% | ✅ | ✅ | dict로 좌표 미리 매핑, min(key=)로 우선순위 비교 |
| [신규 아이디 추천](programmers/lv1/신규아이디추천) | Lv1 | 53% | ✅ | ✅ | 컴프리헨션, re.sub() |
